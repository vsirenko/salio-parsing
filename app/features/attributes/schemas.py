...
def _normalize(value: str) -> str:
    ...
    Case and surrounding punctuation are noise every source adds differently, so they are
    computed away rather than stored as separate rows: `Krāsa`, `krāsa` and `Krāsa:` are
    one alias, not three.
    """
